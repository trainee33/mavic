...
let path = {
	build: {
      ...
      sprites: project_name + '/images/sprite'
	},
	src: {
		favicon: src_folder + '/img/favicon.{jpg,png,svg,gif,ico,webp}',
		html: [ src_folder + '/*.html', '!' + src_folder + '/_*.html' ],
		js: [ src_folder + '/js/vendors/**/*.js', src_folder + '/js/app/**/*.js' ],
		css: src_folder + '/scss/style.scss',
      images: [ src_folder + '/images/**/*.{jpg,png,svg,gif,ico,webp}', '!**/favicon.*', '!**/sprite/*.svg' ],
      svgSprites: [ src_folder + '/images/sprite/**.svg' ],
...
function watchFiles() {
   ...
   gulp.watch('./src/images/sprite/**.svg', svgSprites);
}
